...
namespace shapes 
{
	...
	public:
		...
		static void WriteInfoAboutShapeIntoFileStream(shape *shape, ostream &outFileStream);
		static bool Compare(shape *current, shape *next);
		virtual void ReadDimensionsOfShapeFromFileStream(ifstream &inFileStream) = 0;
		virtual void WriteDimensionsOfShapeIntoFileStream(ostream &outFileStream) = 0;
